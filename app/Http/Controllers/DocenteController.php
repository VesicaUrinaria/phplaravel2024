...
class DocenteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('docentes.index')->with('success','Se creo nuevo Docente con exito.');
    }
    ...
    public function destroy($id)
    {
        ...
        $docente->delete();
        return redirect()->route('docentes.index')->with('success','El docente se elimino con exito');        
    }
